...
enum class PieceType(
    ...
    I(listOf(listOf(1, 1, 1, 1)), R.drawable.sblock_i),
    O(listOf(listOf(1, 1), listOf(1, 1)), R.drawable.sblock_o),
    T(listOf(listOf(0, 1, 0), listOf(1, 1, 1)), R.drawable.sblock_t),
    S(listOf(listOf(0, 1, 1), listOf(1, 1, 0)), R.drawable.sblock_s),
    Z(listOf(listOf(1, 1, 0), listOf(0, 1, 1)), R.drawable.sblock_z),
    J(listOf(listOf(1, 0, 0), listOf(1, 1, 1)), R.drawable.sblock_j),
    L(listOf(listOf(0, 0, 1), listOf(1, 1, 1)), R.drawable.sblock_l);
